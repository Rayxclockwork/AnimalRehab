"""
Django settings for rehab_project project.
...
SECRET_KEY = ')f!+pdudig7(1b7%(e7!#w2*prt!s0-d@&keo6v1=732hnq0*g'
...
ROOT_URLCONF = 'rehab_project.urls'
...
WSGI_APPLICATION = 'rehab_project.wsgi.application'
